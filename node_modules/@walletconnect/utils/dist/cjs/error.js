...
exports.ERROR = {
    ...
    [exports.ERROR_TYPE.SETTLE_TIMEOUT]: {
        ...
        code: 2000,
        stringify: (params) => `${misc_1.capitalize((params === null || params === void 0 ? void 0 : params.context) || defaultParams.context)} failed to settle after ${misc_1.fromMiliseconds(params === null || params === void 0 ? void 0 : params.timeout)} seconds`,
        format: (params) => ({
    ...
    [exports.ERROR_TYPE.JSONRPC_REQUEST_TIMEOUT]: {
        ...
        code: 2001,
        stringify: (params) => `JSON-RPC Request timeout after ${misc_1.fromMiliseconds(params === null || params === void 0 ? void 0 : params.timeout)} seconds: ${params === null || params === void 0 ? void 0 : params.method}`,
        format: (params) => ({
