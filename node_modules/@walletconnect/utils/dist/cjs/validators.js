...
function isSequenceRejected(response) {
    return "reason" in response;
}
exports.isSequenceRejected = isSequenceRejected;
...
function isPairingRejected(response) {
    return "reason" in response;
}
exports.isPairingRejected = isPairingRejected;
...
function isSessionRejected(response) {
    return "reason" in response;
}
exports.isSessionRejected = isSessionRejected;
function isSessionFailed(outcome) {
    return "reason" in outcome;
}
exports.isSessionFailed = isSessionFailed;
function isStoreUpdatedEvent(event) {
    return "update" in event;
}
exports.isStoreUpdatedEvent = isStoreUpdatedEvent;
