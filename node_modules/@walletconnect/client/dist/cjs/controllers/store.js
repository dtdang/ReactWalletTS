...
class Store extends types_1.IStore {
    ...
    set(topic, sequence) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (this.sequences.has(topic)) {
                ...
                this.events.emit(constants_1.STORE_EVENTS.created, {
                    topic,
                    sequence,
                });
            }
    ...
    get(topic) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const sequence = yield this.getSequence(topic);
            return sequence;
        });
    }
    update(topic, update) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const sequence = Object.assign(Object.assign({}, (yield this.getSequence(topic))), update);
            this.sequences.set(topic, sequence);
            this.events.emit(constants_1.STORE_EVENTS.updated, {
                topic,
                sequence,
                update,
            });
    ...
    delete(topic, reason) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            this.events.emit(constants_1.STORE_EVENTS.deleted, {
                topic,
                sequence,
                reason,
            });
    ...
    persist() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            this.events.emit(constants_1.STORE_EVENTS.sync);
        });
    }
    restore() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
    ...
    onInit() {
        this.cached = [];
        this.events.emit(constants_1.STORE_EVENTS.init);
    }
    isInitialized() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise(resolve => {
                this.events.once(constants_1.STORE_EVENTS.init, () => resolve());
            });
        });
    }
    registerEventListeners() {
        this.events.on(constants_1.STORE_EVENTS.created, (createdEvent) => {
            const eventName = constants_1.STORE_EVENTS.created;
            this.logger.info(`Emitting ${eventName}`);
            this.logger.debug({ type: "event", event: eventName, data: createdEvent });
            this.persist();
        });
        this.events.on(constants_1.STORE_EVENTS.updated, (updatedEvent) => {
            const eventName = constants_1.STORE_EVENTS.updated;
            this.logger.info(`Emitting ${eventName}`);
            this.logger.debug({ type: "event", event: eventName, data: updatedEvent });
            this.persist();
        });
        this.events.on(constants_1.STORE_EVENTS.deleted, (deletedEvent) => {
            const eventName = constants_1.STORE_EVENTS.deleted;
            this.logger.info(`Emitting ${eventName}`);
