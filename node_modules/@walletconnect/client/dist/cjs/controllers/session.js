...
const expirer_1 = require("./expirer");
...
class Session extends types_1.ISession {
    constructor(client, logger) {
        ...
        this.name = constants_1.SESSION_CONTEXT;
        this.config = {
        ...
        this.pending = new store_1.Store(client, this.logger, this.config.status.pending);
        this.settled = new store_1.Store(client, this.logger, this.config.status.settled);
        this.history = new history_1.JsonRpcHistory(this.logger, this.client.storage);
        this.expirer = new expirer_1.Expirer(client, this.logger);
    ...
    extend(params) {
        return this.engine.extend(params);
    }
    request(params) {
    ...
    mergeUpgrade(topic, upgrade) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const permissions = {
                jsonrpc: {
                    methods: utils_1.mergeArrays(settled.permissions.jsonrpc.methods, ((_a = upgrade.permissions.jsonrpc) === null || _a === void 0 ? void 0 : _a.methods) || []),
                },
                notifications: {
                    types: utils_1.mergeArrays(((_b = settled.permissions.notifications) === null || _b === void 0 ? void 0 : _b.types) || [], ((_c = upgrade.permissions.notifications) === null || _c === void 0 ? void 0 : _c.types) || []),
                },
                blockchain: {
                    chains: utils_1.mergeArrays(((_d = settled.permissions.blockchain) === null || _d === void 0 ? void 0 : _d.chains) || [], ((_e = upgrade.permissions.blockchain) === null || _e === void 0 ? void 0 : _e.chains) || []),
                },
    ...
    mergeExtension(topic, extension) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const settled = yield this.settled.get(topic);
            if (extension.expiry <= settled.expiry) {
                const error = utils_1.ERROR.INVALID_EXTEND_REQUEST.format({ context: this.name });
