...
class Engine extends types_1.IEngine {
    ...
    create(params) {
        return new Promise((resolve, reject) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            this.sequence.pending.on(constants_1.STORE_EVENTS.updated, (updatedEvent) => tslib_1.__awaiter(this, void 0, void 0, function* () {
    ...
    extend(params) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const settled = yield this.sequence.settled.get(params.topic);
            const participant = { publicKey: settled.self.publicKey };
            if (params.ttl > (yield this.sequence.getDefaultTTL())) {
                const error = utils_1.ERROR.INVALID_EXTEND_REQUEST.format({ context: this.sequence.name });
                this.sequence.logger.error(error.message);
                throw new Error(error.message);
            }
            let extension = { expiry: utils_1.calcExpiry(params.ttl) };
            extension = yield this.handleExtension(params.topic, extension, participant);
            const request = jsonrpc_utils_1.formatJsonRpcRequest(this.sequence.config.jsonrpc.extend, extension);
            yield this.send(settled.topic, request);
            return settled;
        });
    }
    ...
    onResponse(payloadEvent) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (!utils_1.isSequenceRejected(response)) {
                ...
                if (typeof outcome !== "undefined" && !utils_1.isSequenceFailed(outcome)) {
                    yield this.sequence.settled.update(outcome.topic, { acknowledged: true });
                }
            }
            else {
    ...
    onAcknowledge(payloadEvent) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (jsonrpc_utils_1.isJsonRpcError(response) && !utils_1.isSequenceFailed(outcome)) {
                yield this.sequence.settled.delete(outcome.topic, response.error);
            }
            if (typeof outcome !== "undefined" && !utils_1.isSequenceFailed(outcome)) {
                yield this.sequence.settled.update(outcome.topic, { acknowledged: true });
            }
            ...
            if (jsonrpc_utils_1.isJsonRpcRequest(payload)) {
                ...
                switch (request.method) {
                    ...
                    case this.sequence.config.jsonrpc.extend:
                        yield this.onExtension(payloadEvent);
                        break;
    ...
    onExtension(payloadEvent) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const participant = { publicKey: settled.peer.publicKey };
                yield this.handleExtension(topic, request.params, participant);
                const response = jsonrpc_utils_1.formatJsonRpcResult(request.id, true);
                yield this.send(settled.topic, response);
            }
            catch (e) {
    ...
    onNotification(payloadEvent) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { params: notification } = payloadEvent.payload;
            const request = payloadEvent.payload;
            const settled = yield this.sequence.settled.get(payloadEvent.topic);
            try {
                yield this.isNotificationAuthorized(payloadEvent.topic, settled.peer, notification.type);
    ...
    handleUpdate(topic, update, participant) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const state = yield this.sequence.mergeUpdate(topic, update);
            yield this.sequence.settled.update(settled.topic, { state });
            return update;
        });
    }
    handleUpgrade(topic, upgrade, participant) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const permissions = yield this.sequence.mergeUpgrade(topic, upgrade);
            yield this.sequence.settled.update(settled.topic, { permissions });
            return upgrade;
        });
    }
    handleExtension(topic, extension, participant) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const settled = yield this.sequence.settled.get(topic);
            if (participant.publicKey !== settled.permissions.controller.publicKey) {
                const error = utils_1.ERROR.UNAUTHORIZED_EXTEND_REQUEST.format({
                    context: this.sequence.name,
                });
                this.sequence.logger.error(error.message);
                throw new Error(error.message);
            }
            extension = yield this.sequence.mergeExtension(topic, extension);
            yield this.sequence.settled.update(settled.topic, extension);
            return extension;
        });
    }
    ...
    onPendingStatusEvent(event) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (utils_1.isSequenceResponded(pending)) {
                ...
                if (!utils_1.isStoreUpdatedEvent(event)) {
    ...
    subscribeNewPending(createdEvent) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            yield this.sequence.client.relayer.subscribe(topic, {
                relay: pending.relay,
            });
            yield this.sequence.expirer.set(topic, { topic, expiry });
        });
    }
    ...
    registerEventListeners() {
        this.sequence.pending.on(constants_1.STORE_EVENTS.created, (createdEvent) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            yield this.subscribeNewPending(createdEvent);
            yield this.onPendingStatusEvent(createdEvent);
        }));
        this.sequence.pending.on(constants_1.STORE_EVENTS.updated, (updatedEvent) => tslib_1.__awaiter(this, void 0, void 0, function* () { return yield this.onPendingStatusEvent(updatedEvent); }));
        this.sequence.pending.on(constants_1.STORE_EVENTS.deleted, (deletedEvent) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { sequence: pending } = deletedEvent;
            yield this.sequence.client.relayer.unsubscribe(pending.topic, {
                relay: pending.relay,
            });
            yield this.sequence.expirer.del(pending.topic);
        }));
        this.sequence.settled.on(constants_1.STORE_EVENTS.created, (createdEvent) => tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        this.sequence.settled.on(constants_1.STORE_EVENTS.updated, (updatedEvent) => tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        this.sequence.settled.on(constants_1.STORE_EVENTS.deleted, (deletedEvent) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            yield this.sequence.client.relayer.unsubscribe(settled.topic, {
                relay: settled.relay,
            });
            yield this.sequence.expirer.del(settled.topic);
        }));
        this.sequence.settled.on(constants_1.STORE_EVENTS.sync, () => this.sequence.events.emit(this.sequence.config.events.sync));
        ...
        this.sequence.expirer.on(constants_1.EXPIRER_EVENTS.expired, (expiredEvent) => tslib_1.__awaiter(this, void 0, void 0, function* () {
