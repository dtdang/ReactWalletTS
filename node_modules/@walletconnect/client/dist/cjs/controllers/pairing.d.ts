...
export declare class Pairing extends IPairing {
    client: IClient;
    logger: Logger;
    pending: Store<PairingTypes.Pending>;
    settled: Store<PairingTypes.Settled>;
    ...
    extend(params: PairingTypes.ExtendParams): Promise<PairingTypes.Settled>;
    ...
    mergeExtension(topic: string, extension: PairingTypes.Extension): Promise<import("@walletconnect/types").SequenceTypes.Extension>;
