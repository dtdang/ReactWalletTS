...
class Client extends types_1.IClient {
    constructor(opts) {
        ...
        this.controller = (opts === null || opts === void 0 ? void 0 : opts.controller) || constants_1.CLIENT_DEFAULT.controller;
        ...
        this.heartbeat = new controllers_1.HeartBeat({ logger: this.logger });
        this.crypto = new controllers_1.Crypto(this, this.logger, opts === null || opts === void 0 ? void 0 : opts.keychain);
        this.encoder = new controllers_1.Encoder(this, this.logger);
        const storageOptions = Object.assign(Object.assign({}, constants_1.CLIENT_STORAGE_OPTIONS), opts === null || opts === void 0 ? void 0 : opts.storageOptions);
        this.storage = new controllers_1.Storage(this.logger, (opts === null || opts === void 0 ? void 0 : opts.storage) || new keyvaluestorage_1.default(storageOptions), {
            protocol: this.protocol,
            version: this.version,
            context: this.context,
        });
        this.relayUrl = utils_1.formatRelayRpcUrl(this.protocol, this.version, (opts === null || opts === void 0 ? void 0 : opts.relayUrl) || constants_1.CLIENT_DEFAULT.relayUrl, this.projectId);
        this.relayer = new controllers_1.Relayer({
    ...
    pair(params) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const pairing = yield this.pairing.get(pending.outcome.topic);
            return pairing;
        });
    }
    approve(params) {
    ...
    extend(params) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            yield this.session.extend(params);
        });
    }
    request(params) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
    ...
    ping(params) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            yield this.session.ping(params.topic, params.timeout);
        });
    }
    notify(params) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
    ...
    onPairingRequest(request, topic) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (request.method === constants_1.SESSION_JSONRPC.propose) {
                ...
                yield this.pairing.send(topic, response);
            }
        });
    }
    onPairingSettled(pairing) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (pairing.permissions.controller.publicKey === pairing.self.publicKey &&
                ...
                setTimeout(() => tslib_1.__awaiter(this, void 0, void 0, function* () { return yield this.pairing.update({ topic: pairing.topic, state: { metadata: this.metadata } }); }), constants_1.CLIENT_SHORT_TIMEOUT);
            }
        });
    }
    initialize() {
    ...
    registerEventListeners() {
        ...
        this.pairing.on(constants_1.PAIRING_EVENTS.upgraded, (pairing, upgrade) => {
            const eventName = constants_1.CLIENT_EVENTS.pairing.upgraded;
            this.logger.info(`Emitting ${eventName}`);
        ...
        this.session.on(constants_1.PAIRING_EVENTS.sync, () => this.events.emit(constants_1.CLIENT_EVENTS.pairing.sync));
        ...
        this.session.on(constants_1.SESSION_EVENTS.upgraded, (session, upgrade) => {
            const eventName = constants_1.CLIENT_EVENTS.session.upgraded;
            this.logger.info(`Emitting ${eventName}`);
            this.logger.debug({ type: "event", event: eventName, data: session, upgrade });
            this.events.emit(eventName, session, upgrade);
        });
        this.session.on(constants_1.SESSION_EVENTS.extended, (session, extension) => {
            const eventName = constants_1.CLIENT_EVENTS.session.extended;
            this.logger.info(`Emitting ${eventName}`);
        ...
        this.session.on(constants_1.SESSION_EVENTS.sync, () => this.events.emit(constants_1.CLIENT_EVENTS.session.sync));
    }
}
