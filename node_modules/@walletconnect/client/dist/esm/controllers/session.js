...
import { validateSessionProposeParams, validateSessionRespondParams, isValidationInvalid, mergeArrays, ERROR, } from "@walletconnect/utils";
...
export class Session extends ISession {
    constructor(client, logger) {
        ...
        this.pending = new Store(client, this.logger, this.config.status.pending);
        this.settled = new Store(client, this.logger, this.config.status.settled);
    ...
    async mergeUpgrade(topic, upgrade) {
        ...
        const permissions = {
            ...
            blockchain: {
                chains: mergeArrays(((_d = settled.permissions.blockchain) === null || _d === void 0 ? void 0 : _d.chains) || [], ((_e = upgrade.permissions.blockchain) === null || _e === void 0 ? void 0 : _e.chains) || []),
            },
            controller: settled.permissions.controller,
        };
        return permissions;
    }
    async mergeExtension(topic, extension) {
        const settled = await this.settled.get(topic);
