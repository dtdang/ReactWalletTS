...
export class Store extends IStore {
    ...
    async update(topic, update) {
        ...
        const sequence = Object.assign(Object.assign({}, (await this.getSequence(topic))), update);
        this.sequences.set(topic, sequence);
