...
export declare class Engine extends IEngine {
    ...
    extend(params: SequenceTypes.ExtendParams): Promise<SequenceTypes.Settled>;
    ...
    onExtension(payloadEvent: RelayerTypes.PayloadEvent): Promise<void>;
    protected onNotification(payloadEvent: RelayerTypes.PayloadEvent): Promise<void>;
    ...
    handleExtension(topic: string, extension: SequenceTypes.Extension, participant: SequenceTypes.Participant): Promise<SequenceTypes.Extension>;
