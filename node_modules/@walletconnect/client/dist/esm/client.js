...
import { isPairingFailed, isSessionFailed, parseUri, isPairingResponded, isSessionResponded, getAppMetadata, ERROR, formatRelayRpcUrl, } from "@walletconnect/utils";
...
export class Client extends IClient {
    constructor(opts) {
        ...
        const storageOptions = Object.assign(Object.assign({}, CLIENT_STORAGE_OPTIONS), opts === null || opts === void 0 ? void 0 : opts.storageOptions);
        this.storage = new Storage(this.logger, (opts === null || opts === void 0 ? void 0 : opts.storage) || new KeyValueStorage(storageOptions), {
            protocol: this.protocol,
            version: this.version,
            context: this.context,
        });
        this.relayUrl = formatRelayRpcUrl(this.protocol, this.version, (opts === null || opts === void 0 ? void 0 : opts.relayUrl) || CLIENT_DEFAULT.relayUrl, this.projectId);
    ...
    async onPairingRequest(request, topic) {
    ...
    registerEventListeners() {
        ...
        this.pairing.on(PAIRING_EVENTS.upgraded, (pairing, upgrade) => {
        ...
        this.session.on(SESSION_EVENTS.upgraded, (session, upgrade) => {
        ...
        this.session.on(SESSION_EVENTS.extended, (session, extension) => {
