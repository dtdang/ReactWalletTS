...
export declare namespace PairingTypes {
    ...
    type ExtendParams = SequenceTypes.ExtendParams;
    ...
    type Extension = SequenceTypes.Extension;
    ...
    type Approval = SequenceTypes.Approval<State, Participant>;
    type Rejection = SequenceTypes.Rejection;
    type Response = Rejection | Approval;
    ...
    type Engine = IEngine<Pending, Settled, Update, Upgrade, Extension, CreateParams, RespondParams, RequestParams, UpdateParams, UpgradeParams, ExtendParams, DeleteParams, ProposeParams, SettleParams, NotifyParams, Participant, Permissions>;
}
export declare abstract class IPairing extends ISequence<PairingTypes.Engine, PairingTypes.Config, PairingTypes.Pending, PairingTypes.Settled, PairingTypes.Update, PairingTypes.Upgrade, PairingTypes.Extension, PairingTypes.State, PairingTypes.Permissions, PairingTypes.CreateParams, PairingTypes.RespondParams, PairingTypes.RequestParams, PairingTypes.UpdateParams, PairingTypes.UpgradeParams, PairingTypes.ExtendParams, PairingTypes.DeleteParams, PairingTypes.ProposeParams, PairingTypes.SettleParams, PairingTypes.NotifyParams, PairingTypes.Participant, PairingTypes.Signal, PairingTypes.DefaultSignalParams, PairingTypes.ProposedPermissions> {
}
