...
export declare namespace SequenceTypes {
    ...
    interface Approval<S = State, Par = Participant> {
        relay: Relay;
        responder: Par;
        expiry: number;
        state: S;
    ...
    type Response<S = State, Par = Participant> = Rejection | Approval<S, Par>;
    interface Success<S = State, Par = Participant> extends Approval<S, Par> {
        topic: string;
    }
    type Failed = Rejection;
...
export declare abstract class ISequence<Engine = SequenceTypes.Engine, Config = SequenceTypes.Config, Pending = SequenceTypes.Pending, Settled = SequenceTypes.Settled, Update = SequenceTypes.Update, Upgrade = SequenceTypes.Upgrade, Extension = SequenceTypes.Extension, State = SequenceTypes.State, Permissions = SequenceTypes.Permissions, CreateParams = SequenceTypes.CreateParams, RespondParams = SequenceTypes.RespondParams, RequestParams = SequenceTypes.RequestParams, UpdateParams = SequenceTypes.UpdateParams, UpgradeParams = SequenceTypes.UpgradeParams, ExtendParams = SequenceTypes.ExtendParams, DeleteParams = SequenceTypes.DeleteParams, ProposeParams = SequenceTypes.ProposeParams, SettleParams = SequenceTypes.SettleParams, NotifyParams = SequenceTypes.NotifyParams, Participant = SequenceTypes.Participant, Signal = SequenceTypes.Signal, DefaultSignalParams = SequenceTypes.DefaultSignalParams, ProposedPermissions = SequenceTypes.ProposedPermissions> extends IEvents {
    client: IClient;
    logger: Logger;
    abstract pending: IStore<Pending>;
    abstract settled: IStore<Settled>;
    ...
    abstract extend(params: ExtendParams): Promise<Settled>;
    ...
    abstract mergeExtension(topic: string, extension: Extension): Promise<Extension>;
